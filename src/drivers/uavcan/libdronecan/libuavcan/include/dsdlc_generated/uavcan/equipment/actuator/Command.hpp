 ...
 *
 * Source file: /home/mauriciodiaz/Projects/PX4/src/drivers/uavcan/libdronecan/dsdl/uavcan/equipment/actuator/Command.uavcan
 */
...
struct UAVCAN_EXPORT Command_
{
    ...
    struct ConstantTypes
    {
        ...
        typedef ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > COMMAND_TYPE_PWM;
    };
    ...
    static const typename ::uavcan::StorageType< typename ConstantTypes::COMMAND_TYPE_PWM >::Type COMMAND_TYPE_PWM; // 4
...
template <int _tmpl>
const typename ::uavcan::StorageType< typename Command_<_tmpl>::ConstantTypes::COMMAND_TYPE_PWM >::Type
    Command_<_tmpl>::COMMAND_TYPE_PWM = 4U; // 4
