 ...
 *
 * Source file: /home/mauriciodiaz/Projects/PX4/src/drivers/uavcan/libdronecan/dsdl/uavcan/tunnel/Protocol.uavcan
 */
...
struct UAVCAN_EXPORT Protocol_
{
    ...
    struct ConstantTypes
    {
        ...
        typedef ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > MAVLINK2;
        typedef ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > GPS_GENERIC;
        typedef ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > UNDEFINED;
    };
    ...
    static const typename ::uavcan::StorageType< typename ConstantTypes::MAVLINK2 >::Type MAVLINK2; // 1
    static const typename ::uavcan::StorageType< typename ConstantTypes::GPS_GENERIC >::Type GPS_GENERIC; // 2
    static const typename ::uavcan::StorageType< typename ConstantTypes::UNDEFINED >::Type UNDEFINED; // 255
...
template <int _tmpl>
const typename ::uavcan::StorageType< typename Protocol_<_tmpl>::ConstantTypes::MAVLINK2 >::Type
    Protocol_<_tmpl>::MAVLINK2 = 1U; // 1

template <int _tmpl>
const typename ::uavcan::StorageType< typename Protocol_<_tmpl>::ConstantTypes::GPS_GENERIC >::Type
    Protocol_<_tmpl>::GPS_GENERIC = 2U; // 2

template <int _tmpl>
const typename ::uavcan::StorageType< typename Protocol_<_tmpl>::ConstantTypes::UNDEFINED >::Type
    Protocol_<_tmpl>::UNDEFINED = 255U; // 255
